<?php
  ...
  // A context-aware JSON-convertable tree of stuff. Useful for things like service responses 
  // and general tree stuff.
  //
  ...
  //   2) an array of specific path tokens
  ...
  // SECTION: Root management.
    ...
    {
      $steps = $this->canonicalize_path($path);
      return new JsonTree_RootScope($this, $steps);
    }
