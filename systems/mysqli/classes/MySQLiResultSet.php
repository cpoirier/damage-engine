<?php if (defined($inc = "MYSQLIRESULTSET_INCLUDED")) { return; } else { define($inc, true); }
  ...
  //===============================================================================================
  // SECTION: Converters (closes the set before returning)
  ...
  //===============================================================================================
  // SECTION: Iterator interface (used by PHP foreach)
